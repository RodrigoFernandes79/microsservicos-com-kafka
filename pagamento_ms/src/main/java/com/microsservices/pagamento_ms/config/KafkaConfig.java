...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.pagamento-sucess}")
    private String pagamentoSucessTopic;
     ...
     */
    public KafkaConfig(String bootstrapServers, String groupId, String autoOffsetReset, String orchestratorTopic, String pagamentoSucessTopic, String pagamentoFailTopic) {
        this.bootstrapServers = bootstrapServers;
        this.groupId = groupId;
        this.autoOffsetReset = autoOffsetReset;
        this.orchestratorTopic = orchestratorTopic;
        this.pagamentoSucessTopic = pagamentoSucessTopic;
        this.pagamentoFailTopic = pagamentoFailTopic;
    }
    ...
    public NewTopic pagamentoSucessTopic() {
        return buildTopic(pagamentoSucessTopic);
    }
